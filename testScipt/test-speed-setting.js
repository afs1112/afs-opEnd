...
testSpeedCommands.forEach((testCase, index) => {
  ...
  try {
    ...
    if (
      !setSpeedParam.speed ||
      setSpeedParam.speed < 1 ||
      setSpeedParam.speed > 100
    ) {
    ...
    console.log(
      `  📊 平台: ${platformName}, 目标速度: ${setSpeedParam.speed} m/s`
    );
    ...
    if (
      deserialized.setSpeedParam.speed === testCase.data.setSpeedParam.speed
    ) {
